...
**Contributors:** [yudhisthirnahar](https://profiles.wordpress.org/yudhisthirnahar)  
**Tags:** blocks, gutenberg, custom-blocks, wordpress-blocks, wordpress-block-starter-kit, block-development, wordpress-block-examples, wordpress-block-tutorial  
...
* **Demo Block**: Simple demonstration block with qualification and percentage, block registered via JS having multiple output versions to be defined under deprecated.
* **MCQ Block**: Simple demonstration block with mcq quiz with color picker and alignment toolbar in admin side
* **Featured Author**: Showcase featured authors using SelectControl and wp core useSelect
* **Feature WC Product Block**: Showcase block having WooCommerce products with search functionality and fetching products from API, localizations
